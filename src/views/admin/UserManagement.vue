  ...
  <div class="user-manage-container">
    <div class="toolbar">
      <el-input
        ...
        placeholder="搜索"
        clearable
        @clear="() => { currentPage.value = 1; loadUsers() }"
        @keyup.enter="() => { currentPage.value = 1; loadUsers() }"
        style="width: 240px;"
      />
    ...
    <el-table :data="users" border stripe v-loading="loading" style="width: 100%;">
      <el-table-column prop="username" label="编号" width="80" />
    ...
    <el-dialog title="添加用户" v-model="showAddDialog" width="500px" destroy-on-close>
      <UserAddForm @added="onUserAdded" @cancel="showAddDialog = false" />
    </el-dialog>
  </div>
</template>
